...
/* here is the sample structure of a monspec file
{
    "SampleJSonService" : {
        ...
        "_resolved_comparision" : "StagingToProduction" <<-- will be filled with the actual comparision configuration name we used
...
exports.getAllTagRules = function (monspec, environmentname) {
    ...
    console.log("getAllTagRules: For " + environmentname + " we returned tagRules: " + JSON.stringify(tagRules));
    return tagRules;
}
...
exports.getComparisonConfiguration = function(entityDef, comparisonconfigname) {
    if(!entityDef.comparisons) console.log("has it");
